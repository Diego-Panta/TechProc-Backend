...
class GradeReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'evaluation_type' => 'nullable|in:Exam,Quiz,Project,Assignment,Final', // CORREGIDO
    ...
    public function messages(): array
    {
        return [
            ...
            'evaluation_type.in' => 'El tipo de evaluación debe ser Exam, Quiz, Project, Assignment o Final', // CORREGIDO
