...
class UpdateAlertRequest extends FormRequest
{
    ...
    {
        return [
            // Campos OPCIONALES para actualización de ALERT
            'title' => 'sometimes|string|max:255',
            'content' => 'sometimes|string|min:10|max:1000',
            'status' => 'sometimes|string|in:' . implode(',', ContentStatus::forAlert()),
            ...
            'item_type' => 'nullable|string|in:' . implode(',', AlertItemType::all()),
