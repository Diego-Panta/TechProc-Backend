...
<body>
    <div class="form-container">
        ...
        @if (session('success'))
            <div
                style="color: green; padding: 10px; background: #d4edda; border: 1px solid #c3e6cb; margin-bottom: 15px;">
                {{ session('success') }}
            </div>
        @endif
        ...
        <form method="POST" action="{{ route('developer-web.announcements.store') }}">
            @csrf
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="display_type" name="display_type" required>
                        ...
                        <option value="popup" {{ old('display_type') == 'popup' ? 'selected' : '' }}>Popup</option>
                        <option value="notification" {{ old('display_type') == 'notification' ? 'selected' : '' }}>
                            Notificación</option>
                    </select>
                    @error('display_type')
                        <div class="error">{{ $message }}</div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="target_page" name="target_page" value="{{ old('target_page') }}"
            ...
            <div class="preview-section">
                ...
                <div id="preview-content" style="padding: 15px; border: 1px dashed #ccc; border-radius: 5px;">
                    <p><strong id="preview-title">[Título del anuncio]</strong></p>
                    <p id="preview-content-text">[Contenido del anuncio]</p>
                    <div id="preview-button" style="display: none;">
                        <button type="button"
                            ...
                            <span id="preview-button-text">Botón</span>
                        </button>
                    </div>
                    <p style="font-size: 12px; color: #666; margin-top: 10px;">
                        Tipo: <span id="preview-type">[Tipo]</span> |
                        Página: <span id="preview-page">[Página]</span>
                    </p>
                </div>
            </div>
